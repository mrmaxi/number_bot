...
from redis_util import RedisDictStore, RedisSimpleStore, RedisDict, redis_from_url_or_object
...
class RedisPersistence(BasePersistence):
        ...
        def get_conversations(self, name: str) -> ConversationDict:
            ...
            if conversation is None:
                conversation = RedisSimpleStore(redis_url=self._redis, id=f'{self.id_prefix}conversations:{name}')
